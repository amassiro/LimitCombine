...
class Higgswidth(PhysicsModel):
	...
	if self.GGsmfixed:
        ...
        self.modelBuilder.factory_("expr::ggH_s_funcWW(\"@0*@2*@1*@3-sqrt(@0*@2*@1*@3)\",R,CMS_zz4l_GGsm,kgluon_WW,gammaK)")
        self.modelBuilder.factory_("expr::ggH_b_funcWW(\"1-sqrt(@0*@2*@1*@3)\",R,CMS_zz4l_GGsm,kgluon_WW,gammaK)")
        self.modelBuilder.factory_("expr::ggH_sbi_funcWW(\"sqrt(@0*@2*@1*@3)\",R,CMS_zz4l_GGsm,kgluon_WW,gammaK)")

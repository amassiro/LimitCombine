...
text2workspace.py -m 125.6 hwidth_0jet-7TeV-8TeV.txt        -P LimitCombine.HiggsWidth.HiggsWidthKappaCustodialMHSscaleWWOriginal:higgswidth   --PO=is2l2nu --PO=MHScaleWW  -o    model_hwwlvlv_0j-7TeV-8TeV.root
text2workspace.py -m 125.6 hwidth_1jet-7TeV-8TeV.txt        -P LimitCombine.HiggsWidth.HiggsWidthKappaCustodialMHSscaleWWOriginal:higgswidth   --PO=is2l2nu --PO=MHScaleWW  -o    model_hwwlvlv_1j-7TeV-8TeV.root
text2workspace.py -m 125.6 hwidth_2jet-7TeV-8TeV.txt        -P LimitCombine.HiggsWidth.HiggsWidthKappaCustodialMHSscaleWWOriginal:higgswidth   --PO=is2l2nu --PO=MHScaleWW  -o    model_hwwlvlv_2j-7TeV-8TeV.root
...
# combine   -M MultiDimFit model_hwwlvlv_012j-7TeV-8TeV.root  --algo=grid --points 240  -m 125.6   --setPhysicsModelParameterRanges CMS_zz4l_GGsm=0.000001,1       --minimizerAlgo=Minuit2 --minimizerAlgoForMinos=Minuit2 --minimizerStrategy=1 --minimizerTolerance=0.009 --minimizerToleranceForMinos=0.01 --cminFallbackAlgo Minuit,0.001  --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP --X-rtd FITTER_BOUND     --verbose -1

...
import ROOT
parser = OptionParser(usage="usage: %prog [options] workspace \nrun with --help to get list of options")
...
parser.add_option("-n", "--points",   dest="points",   default=1,  type="int",  help="Points to choose in the range (note: both endpoints are included)")

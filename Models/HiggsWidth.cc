#include "Riostream.h"
// #include "../interface/HWW2L2V_RooHiggsWidthPdf.h"
// #include "HWW2L2V_RooHiggsWidthPdf.h"
...
ClassImp(HWW2L2V_RooHiggsWidthPdf)
 
  HWW2L2V_RooHiggsWidthPdf::HWW2L2V_RooHiggsWidthPdf(const char *name, const char *title,
                                             RooAbsReal& _kd,
                                             //RooAbsReal& _kdint,
                                             //RooAbsReal& _ksmd,
                                             RooAbsReal& _fai,
...
//   ksmd("ksmd","ksmd",this,_ksmd),
 ...
 
 {
  ...
  while((func = (RooAbsArg*)coefIter->Next())) {
    if (!dynamic_cast<RooAbsReal*>(func)) {
      coutE(InputArguments) << "ERROR: :HWW2L2V_RooHiggsWidthPdf(" << GetName() << ") funcficient " << func->GetName() << " is not of type RooAbsReal" << endl;
      assert(0);
    }
    _coefList.add(*func) ;
  }
 ...
 HWW2L2V_RooHiggsWidthPdf::HWW2L2V_RooHiggsWidthPdf(const HWW2L2V_RooHiggsWidthPdf& other, const char* name) :  
 ...
 Double_t HWW2L2V_RooHiggsWidthPdf::evaluate() const
 {
   double value = 0.;
...
Int_t HWW2L2V_RooHiggsWidthPdf::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const
{
...
Double_t HWW2L2V_RooHiggsWidthPdf::analyticalIntegral(Int_t code, const char* rangeName) const
{
   switch(code)
     {
